---
title: PublicProfile\_LogFileSize
description: PublicProfile\_LogFileSize
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 8131e1c7-0bbe-4de4-aace-0de4ae0ecebb
...
# PublicProfile\_LogFileSize


`PublicProfile_LogFileSize` specifies the size of the default log file for Windows Firewall for the public profile.
