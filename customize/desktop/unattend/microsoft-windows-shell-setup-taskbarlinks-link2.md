...
ms.assetid: aed3c4ea-ceeb-4151-9194-fadd2eacdcbb
...
`Link2` specifies the path to the third available program shortcut on the taskbar.
...
<td><p>Specifies the path to the third program shortcut on the taskbar. <em>Path_to_third_link</em> is a string with a maximum length of 259 characters.</p>
...
[Microsoft-Windows-Shell-Setup](microsoft-windows-shell-setup.md) | [TaskbarLinks](microsoft-windows-shell-setup-taskbarlinks.md) | **Link2**
