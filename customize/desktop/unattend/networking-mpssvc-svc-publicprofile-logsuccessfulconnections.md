---
title: PublicProfile\_LogSuccessfulConnections
description: PublicProfile\_LogSuccessfulConnections
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: a1a4d857-0998-4c6f-ae93-2d25faa9959d
...
# PublicProfile\_LogSuccessfulConnections


`PublicProfile_LogSuccessfulConnections` specifies whether to log successful connections for Windows Firewall for the public profile.
...
<td><p>Specifies that successful connections are logged for the public profile.</p></td>
</tr>
<tr class="even">
<td><p><strong>false</strong></p></td>
<td><p>Specifies that successful connections are not logged for the public profile. This is the default value.</p></td>
</tr>
</tbody>
</table>
...
[Networking-MPSSVC-Svc](networking-mpssvc-svc.md) | **PublicProfile\_LogSuccessfulConnections**
