...
<p>For more information about reviewing system crashes, see <a href="troubleshooting-windows-hlk-test-failures.md#sysx" data-raw-source="[Troubleshooting Windows HLK Test Failures (system crashes)](troubleshooting-windows-hlk-test-failures.md#sysx)">Troubleshooting Windows HLK Test Failures (system crashes)</a>.</p></td>
</tr>
<tr class="even">
