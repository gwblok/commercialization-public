---
title: Link training on virtual mode change
Description: Link training on virtual mode change
ms.assetid: 
...
check driver reports any HPD due to possible link training during virtual mode change.
