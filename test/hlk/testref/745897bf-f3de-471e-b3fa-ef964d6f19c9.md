---
title: WDDM2.2 Periodic frame notification - Very close to each other
Description: WDDM2.2 Periodic frame notification - Very close to each other
ms.assetid: 
...
Schedules notifications that are only one scan line apart from each other and makes sure both are signaled correctly.
