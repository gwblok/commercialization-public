---
title: Camera Driver Test - Preview (Sample Grabber), Record H.264 Video and AAC Audio from each Capture Stream type
description: Camera Driver Test - Preview (Sample Grabber), Record H.264 Video and AAC Audio from each Capture Stream type
MSHAttr:
