---
title: Camera Driver Controls System Test - FOCUSMODE - Iterate through possible settings while Previewing after start streaming for a few seconds
description: Camera Driver Controls System Test - FOCUSMODE - Iterate through possible settings while Previewing after start streaming for a few seconds
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 5c4dd7cd-5926-43bc-a34d-1b3523841716
...
# <span id="p_hlk_test.79fb2444-8aa4-42e8-ad04-28b338b1ff83"></span>Camera Driver Controls System Test - FOCUSMODE - Iterate through possible settings while Previewing after start streaming for a few seconds
