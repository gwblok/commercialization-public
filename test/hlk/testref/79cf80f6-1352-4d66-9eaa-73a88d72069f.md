---
title: Activity sensor minimum report interval verification tests
Description: Activity sensor minimum report interval verification tests
ms.assetid: 
...
# Activity sensor minimum report interval verification tests
...
|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.ActivitySensor.MinimumReportInterval</li></ul> |  
