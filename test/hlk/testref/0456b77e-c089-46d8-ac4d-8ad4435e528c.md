---
title: Sensor Camera Driver Controls System Test - VIDEOHDR - Verify Fail to turn off Video HDR on Video HDR while streaming with with STATUS_INVALID_DEVICE_STATE
description: Sensor Camera Driver Controls System Test - VIDEOHDR - Verify Fail to turn off Video HDR on Video HDR while streaming with with STATUS\_INVALID\_DEVICE\_STATE
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: fe04a3b7-22d4-427d-9811-144abdd688db
...
# Sensor Camera Driver Controls System Test - VIDEOHDR - Verify Fail to turn off Video HDR on Video HDR while streaming with with STATUS_INVALID_DEVICE_STATE
