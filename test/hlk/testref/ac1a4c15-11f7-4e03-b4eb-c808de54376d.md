---
title: UCSI Power Direction Role command \Type-C MUTT\
Description: UCSI Power Direction Role command [Type-C MUTT]
ms.assetid: 
...
# UCSI Power Direction Role command \[Type-C MUTT\]
