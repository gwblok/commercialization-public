---
title: UCSI Power Direction Role command - Reset on PPM-Reset \Type-C MUTT\
Description: UCSI Power Direction Role command - Reset on PPM-Reset [Type-C MUTT]
ms.assetid: 
...
# UCSI Power Direction Role command - Reset on PPM-Reset \[Type-C MUTT\]

Verifies that the power role requested using the UCSI Set Power Direction Role command is reset on performing a PPM-Reset.
