---
title: D3D12 - Depth Bounds Test - Verify Depth Bounds Test correctly limits writes to the Render Target as well as UAVs when range is set to \-FLT_MAX, FLT_MAX\
Description: D3D12 - Depth Bounds Test - Verify Depth Bounds Test correctly limits writes to the Render Target as well as UAVs when range is set to [-FLT_MAX, FLT_MAX] 
ms.assetid: 
