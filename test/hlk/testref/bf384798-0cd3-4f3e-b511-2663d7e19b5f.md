---
title: Get DC (WoW64)
description: Get DC (WoW64)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 0f234bfd-d06b-460d-b9e1-ee0210c124ff
...
# <span id="p_hlk_test.bf384798-0cd3-4f3e-b511-2663d7e19b5f"></span>Get DC (WoW64)


This automated test verifies that a graphics adapter of chipset implements the minimum hardware acceleration capabilities as described in the requirements document.
...
<tbody>
<tr class="odd">
<td><p><strong>Getdc.exe -M:1 -dx9 -whql -logclean</strong></p></td>
<td><p>This command runs the Get DC test job.</p></td>
</tr>
<tr class="even">
<td><p><strong>Getdc.exe -M:1 -whql -logclean</strong></p></td>
<td><p>This command runs the Get DC (WoW64) test job.</p></td>
</tr>
</tbody>
</table>
