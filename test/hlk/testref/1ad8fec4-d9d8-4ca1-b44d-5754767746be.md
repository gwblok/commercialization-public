---
title: UCSI commands - Get Connector Status, Request Data Object \Type-C MUTT\
Description: UCSI commands - Get Connector Status, Request Data Object [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Get Connector Status, Request Data Object \[Type-C MUTT\]

Verifies that the system supports the UCSI Get Connector Status command, for retrieving the Power Delivery Request Data Object.
