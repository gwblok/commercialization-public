---
title: UCSI Power Direction Role command - No connection \Type-C MUTT\
Description: UCSI Power Direction Role command - No connection [Type-C MUTT]
ms.assetid: 
...
# UCSI Power Direction Role command - No connection \[Type-C MUTT\]

Verifies that the UCSI Set Power Direction Role command fails if a partner is not currently attached.
