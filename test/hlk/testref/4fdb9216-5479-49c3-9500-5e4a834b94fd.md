---
title: Wireless Display Verify Topology
description: Wireless Display Verify Topology
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: b5ffbd89-b3dc-41fb-9713-364497482762
...
# <span id="p_hlk_test.4fdb9216-5479-49c3-9500-5e4a834b94fd"></span>Wireless Display Verify Topology


This automated test verifies that the graphics driver can reach all valid topologies. The test installs a software device to emulate Miracast sink, starts a session, and then verifies that all valid topologies can be set.
...
<tbody>
<tr class="odd">
<td><p>Failed to reach the starting state topology.</p></td>
<td><p>Driver failed to set basic topology.</p></td>
</tr>
<tr class="even">
<td><p>Miracast display is no longer present after topology change.</p></td>
<td><p>Driver failed to connect Miracast display.</p></td>
</tr>
<tr class="odd">
<td><p>Failed to reach the target topology.</p></td>
<td><p>Driver failed to set desired topology.</p></td>
</tr>
</tbody>
</table>
