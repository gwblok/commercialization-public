---
title: Relative Orientation Sensor Thresholds Verification Test
Description: Relative Orientation Sensor Thresholds Verification Test
ms.assetid: 
...
# Relative Orientation Sensor Thresholds Verification Test

Verifies that the required thresholds fields are present in Relative Orientation Sensor

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.RelativeOrientation.Thresholds</li></ul> |  
