---
title: UCSI Connector Reset command \Type-C MUTT\
Description: UCSI Connector Reset command [Type-C MUTT]
ms.assetid: 
...
# UCSI Connector Reset command \[Type-C MUTT\]

Verifies that the system supports the UCSI Connector Reset command.
