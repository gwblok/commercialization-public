---
title: Ambient light sensor minimum report interval verification tests
Description: Ambient light sensor minimum report interval verification tests
ms.assetid: 
...
# Ambient light sensor minimum report interval verification tests
...
|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.AmbientLightSensor.MinimumReportInterval</li></ul> |  
