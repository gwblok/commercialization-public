---
title: Camera Driver Test - Photo Capture - Capture a BGRA8 photo from each type exposed by the photo pin
description: Camera Driver Test - Photo Capture - Capture a BGRA8 photo from each type exposed by the photo pin
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: dd09aa17-6ef8-4dcf-aaf5-601b01884f56
...
# <span id="p_hlk_test.ca6f048b-c491-46b0-9f28-9a936d6d76ed"></span>Camera Driver Test - Photo Capture - Capture a BGRA8 photo from each type exposed by the photo pin
