---
title: Color Fill (WoW64)
description: Color Fill (WoW64)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 8d23c782-e044-4d7e-a0e2-e43f3afaeef5
...
# <span id="p_hlk_test.e0133ddf-15f9-4687-b450-a8fbbd6e6448"></span>Color Fill (WoW64)
...
- The type of destination surface for the ColorFill operation. Valid types are:
  ...
  - Offscreen plain surfaces in the D3DPOOL\_DEFAULT memory pool.

  - Surfaces that belong to render target textures.

    > [!NOTE]
    > 
    > The destination surface is always in the D3DPOOL\_DEFAULT memory pool.
...
<tbody>
<tr class="odd">
<td><p><strong>Colorfill -M:1 -whql -logclean -dx9</strong></p></td>
<td><p>Runs the Color Fill test job.</p></td>
</tr>
<tr class="even">
<td><p><strong>Colorfill -M:1 -whql -logclean</strong></p></td>
<td><p>Runs the Color Fill (WoW64) test job.</p></td>
</tr>
</tbody>
</table>
