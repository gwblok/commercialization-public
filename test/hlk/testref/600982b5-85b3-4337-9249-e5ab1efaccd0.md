---
title: Link training on monitor power transition
Description: Link training on monitor power transition
ms.assetid: 
...
check driver reports any HPD due to possible link training during monitor power transition.
