---
title: VideoProcessor - Tone mapper hue consistency - HDR to SDR, HDR to HDR
Description: VideoProcessor - Tone mapper hue consistency - HDR to SDR, HDR to HDR
ms.assetid: 
...
# VideoProcessor - Tone mapper hue consistency - HDR to SDR, HDR to HDR
