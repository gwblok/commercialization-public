---
title: UCSI Get Connector Status - External Supply Change \Type-C MUTT\
Description: UCSI Get Connector Status - External Supply Change [Type-C MUTT]
ms.assetid: 
...
# UCSI Get Connector Status - External Supply Change \[Type-C MUTT\]

Verifies that the system reports an 'External Supply Change' notification in response to a charger being connected.
...
| **ExternalSupplyChangeNotification** | Set to False if the SUT cannot trigger the External Supply Change notification. |
