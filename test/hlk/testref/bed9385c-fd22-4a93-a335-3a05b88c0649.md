---
title: Camera Driver Test - Photo Capture - Capture a JPEG photo from the default format advertised on the camera's preferred stream for photo
description: Camera Driver Test - Photo Capture - Capture a JPEG photo from the default format advertised on the camera's preferred stream for photo
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 89551710-19b0-4344-9997-d51fc16a99cf
...
# <span id="p_hlk_test.bed9385c-fd22-4a93-a335-3a05b88c0649"></span>Camera Driver Test - Photo Capture - Capture a JPEG photo from the default format advertised on the camera's preferred stream for photo
