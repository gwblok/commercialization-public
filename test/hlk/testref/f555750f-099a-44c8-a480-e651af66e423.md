---
title: D3D12 - Depth Bounds Test - Verify Depth Bounds Test correctly limits writes to the Render Target when no depth buffer is bound and range is set to \0,1\
Description: D3D12 - Depth Bounds Test - Verify Depth Bounds Test correctly limits writes to the Render Target when no depth buffer is bound and range is set to [0,1] 
ms.assetid: 
