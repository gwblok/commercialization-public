---
title: D3D12 - Metacommands - Validate Dirty State
Description: D3D12 - Metacommands - Validate Dirty State
ms.assetid: 
...
Tests that metacommand execution does not change unintended state.
