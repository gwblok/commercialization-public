---
title: Link training on system sleep
Description: Link training on system sleep
ms.assetid: 
...
check driver reports any HPD due to possible link training during system sleep and resume.
