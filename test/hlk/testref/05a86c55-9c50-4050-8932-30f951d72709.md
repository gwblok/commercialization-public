---
title: WDDM2.4 Mandatory Caps
Description: WDDM2.4 Mandatory Caps
ms.assetid: 
...
Tests whether mandatory WDDM2.4+ caps are set.

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Graphics.WDDM24.CoreRequirement</li></ul> |  
