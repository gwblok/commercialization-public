---
title: UCSI USB Operation Mode command - UFP to UFP connection \Type-C MUTT\
Description: UCSI USB Operation Mode command - UFP to UFP connection [Type-C MUTT]
ms.assetid: 
...
# UCSI USB Operation Mode command - UFP to UFP connection \[Type-C MUTT\]

Sets the UCSI USB Operation Mode of the system to UFP and the partner to UFP and confirms that a connection cannot be established.
