---
title: WDDM - OfferReclaim11 - Decommit Force Decommit Test
Description: WDDM - OfferReclaim11 - Decommit Force Decommit Test
ms.assetid: 
...
Validates the use of the verifier flag used to force allocations to be decommitted on reclaim.
