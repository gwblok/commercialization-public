---
title: Sensor Camera Driver Controls System Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_HighQualityPhoto is supported, set first index
description: Sensor Camera Driver Controls System Test - CAMERA\_PROFILES - Verify KSCAMERAPROFILE\_HighQualityPhoto is supported, set first index
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 565ddebd-4f96-4e39-8f3f-14c75c2d02cb
...
# Sensor Camera Driver Controls System Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_HighQualityPhoto is supported, set first index
