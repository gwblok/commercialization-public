---
title: Wireless Display Verify Edid
description: Wireless Display Verify Edid
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 75a5fe5e-1ae6-4c4f-b15b-3579d31445da
...
# <span id="p_hlk_test.e3862d07-381b-4821-9c53-f1d60173a6c3"></span>Wireless Display Verify Edid


This automated test verifies that the graphics driver correctly reports the same EDID that is reported by the sink device for the Miracast display. The test installs a software device to emulate Miracast sink and repeatedly connects/disconnects different displays to the sink.
...
<tbody>
<tr class="odd">
<td><p>Unable to retrieve Miracast monitor properties.</p></td>
<td><p>Driver failed to connect a Miracast monitor.</p></td>
</tr>
<tr class="even">
<td><p>Failed: Driver provides incorrect EDID data.</p></td>
<td><p>Driver modified EDID for Miracast monitor.</p></td>
</tr>
</tbody>
</table>
