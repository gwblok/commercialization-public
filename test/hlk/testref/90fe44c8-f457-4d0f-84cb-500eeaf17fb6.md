...
<td><p>If the log file shows that the test failed to find certain events, check the implementation of threshold notification events and permanent resource exhaustion event in <a href="http://go.microsoft.com/fwlink/?LinkID=309287" data-raw-source="[Plan and Deploy Thin Provisioning](http://go.microsoft.com/fwlink/?LinkID=309287)">Plan and Deploy Thin Provisioning</a>.</p></td>
</tr>
<tr class="even">
