---
title: UCSI commands - Get Connector Alternate Modes Supported \Type-C MUTT\
Description: UCSI commands - Get Connector Alternate Modes Supported [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Get Connector Alternate Modes Supported \[Type-C MUTT\]

Verifies that the system supports the UCSI Get Connector Alternate Modes Supported command.
