---
title: Gravity Vector Sensor Thresholds Verification Test
Description: Gravity Vector Sensor Thresholds Verification Test
ms.assetid: 
...
# Gravity Vector Sensor Thresholds Verification Test

Verifies that the required thresholds fields are present in Gravity Vector Sensor

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.GravityVectorSensor.Thresholds</li></ul> |  
