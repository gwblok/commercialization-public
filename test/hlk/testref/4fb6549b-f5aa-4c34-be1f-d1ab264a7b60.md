---
title: UCSI Get Connector Status - Fail connector reset in dead battery condition \Type-C MUTT\
Description: UCSI Get Connector Status - Fail connector reset in dead battery condition [Type-C MUTT]
ms.assetid: 
...
# UCSI Get Connector Status - Fail connector reset in dead battery condition \[Type-C MUTT\]

Verifies that a connector reset performed on a connector that powered up the system from a dead-battery condition fails.
