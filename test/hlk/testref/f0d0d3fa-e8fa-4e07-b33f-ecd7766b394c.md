---
title: WinRT LinearAccelerometer GetCurrentReading
Description: WinRT LinearAccelerometer GetCurrentReading
ms.assetid: 
...
# WinRT LinearAccelerometer GetCurrentReading

Windows::Devices::Sensors::LinearAccelerometer C++/Cx Functional Tests

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.LinearAccelerometer.WinRT.Discretional</li></ul> |  
