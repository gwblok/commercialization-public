---
title: Wireless Display Verify Mode Change
description: Wireless Display Verify Mode Change
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 253e9109-c45a-45b8-ae0e-c65a7f5bb5da
...
# <span id="p_hlk_test.92bee126-d3ba-4965-86c9-99691f4c2c56"></span>Wireless Display Verify Mode Change


This automated test verifies that the graphics driver can reach all reported resolutions and correctly report refresh rate and protocol events. The test installs a software device to emulate Miracast sink, starts a session, and then verifies that the driver can correctly set display modes.
...
<tbody>
<tr class="odd">
<td><p>Failed to get a mode list for the miracast display.</p></td>
<td><p>Driver failed to supply a mode list for the Miracast display.</p></td>
</tr>
<tr class="even">
<td><p>Expected resolution of … found …</p></td>
<td><p>Driver failed to set desired resolution.</p></td>
</tr>
<tr class="odd">
<td><p>Failed while waiting for protocol event from driver. Allowed timeout: 3000ms.</p></td>
<td><p>Driver failed to respond on protocol event in timely manner.</p></td>
</tr>
<tr class="even">
<td><p>Unexpected mode enumerated by the display driver. Expected only modes with …hz refresh rate. Found: ..</p></td>
<td><p>Driver reported incorrect refresh rate.</p></td>
</tr>
</tbody>
</table>
