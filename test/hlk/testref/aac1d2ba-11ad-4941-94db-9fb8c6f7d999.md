---
title: Relative orientation sensor minimum report interval verification tests
Description: Relative orientation sensor minimum report interval verification tests
ms.assetid: 
...
# Relative orientation sensor minimum report interval verification tests
...
|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.RelativeOrientation.MinimumReportInterval</li></ul> |  
