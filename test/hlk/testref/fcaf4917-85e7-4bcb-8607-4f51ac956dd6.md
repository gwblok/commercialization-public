---
title: Sensor Camera Driver Controls System Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_VideoRecording is supported, set first index
description: Sensor Camera Driver Controls System Test - CAMERA\_PROFILES - Verify KSCAMERAPROFILE\_VideoRecording is supported, set first index
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: e53bdefb-df4a-4df4-8c6c-69abe21d7518
...
# Sensor Camera Driver Controls System Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_VideoRecording is supported, set first index
