---
title: Custom Properties Verification Test for All Sensors
Description: Custom Properties Verification Test for All Sensors
ms.assetid: 
...
# Custom Properties Verification Test for All Sensors

Verifies that the custom data fields for all sensors are of expected type

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.General.DataTypes</li></ul> |  
