---
title: Camera Driver Test - MultiStream (Scenario) - Preview (Sample Grabber), Capture GIF Photo
description: Camera Driver Test - MultiStream (Scenario) - Preview (Sample Grabber), Capture GIF Photo
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 422d5f74-b774-4726-824f-ba100cef886a
...
# <span id="p_hlk_test.411fbfe1-4983-43b6-9713-d5e3a397af08"></span>Camera Driver Test - MultiStream (Scenario) - Preview (Sample Grabber), Capture GIF Photo
