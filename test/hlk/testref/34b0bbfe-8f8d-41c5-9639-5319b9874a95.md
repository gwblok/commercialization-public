---
title: D3D12 - Copy Queue Timestamps
Description: D3D12 - Copy Queue Timestamps
ms.assetid: 
...
Verifies that (on drivers that report support) timestamps on copy command queues function correctly.
