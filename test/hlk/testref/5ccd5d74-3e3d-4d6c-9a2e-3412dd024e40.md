---
title: Pixel Shaders Ver 2.x (WoW64)
description: Pixel Shaders Ver 2.x (WoW64)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: a0dab872-732a-4d53-b47e-3f1efebc3040
...
# <span id="p_hlk_test.5ccd5d74-3e3d-4d6c-9a2e-3412dd024e40"></span>Pixel Shaders Ver 2.x (WoW64)
...
|**Expected run time (in minutes)**| 80 |
|**Category**| Compatibility |
|**Timeout (in minutes)**| 4800 |
