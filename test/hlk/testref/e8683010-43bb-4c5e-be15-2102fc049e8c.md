---
title: UCSI commands - Get Capability \Type-C MUTT\
Description: UCSI commands - Get Capability [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Get Capability \[Type-C MUTT\]

Verifies that the system supports the UCSI Get Capability command.
