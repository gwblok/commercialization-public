---
title: Magnetometer Dynamic Range Tests
Description: Magnetometer Dynamic Range Tests
ms.assetid: 
...
# Magnetometer Dynamic Range Tests

Verifies that the dynamic range for Magnetometer data fields are withing range

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>System.Client.Sensor.Magnetometer.DynamicRange</li></ul> |  
