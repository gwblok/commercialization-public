---
title: Camera Driver Controls System Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_HighQualityPhoto is supported, set first index
description: Camera Driver Controls System Test - CAMERA\_PROFILES - Verify KSCAMERAPROFILE\_HighQualityPhoto is supported, set first index
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 16a9446b-aadb-44d0-9296-b2ea34442019
...
# Camera Driver Controls System Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_HighQualityPhoto is supported, set first index
