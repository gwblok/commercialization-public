---
title: Wireless Display Verify Protocol
description: Wireless Display Verify Protocol
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 696b8d12-15b6-4a6e-baec-f1712c03778a
...
# <span id="p_hlk_test.6b155c14-57f7-4435-a0af-840658db08c0"></span>Wireless Display Verify Protocol


This automated test verifies that the graphics driver can handle Miracast protocol errors. The test installs a software device to emulate Mircacast sink, starts session and then verifies that the driver can correctly handle protocol errors induced by the test.
...
<td><p>The test failed to generate the desired event.</p></td>
</tr>
<tr class="even">
<td><p>Expected the driver to time-out and disconnect the session due to message corruption and incomplete message sequence.</p></td>
<td><p>Driver failed to disconnect the session due to a fatal error that was caused by the test.</p></td>
</tr>
</tbody>
</table>
