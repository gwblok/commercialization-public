---
title: Link training on physical mode change
Description: Link training on physical mode change
ms.assetid: 
...
check driver reports any HPD due to possible link training during physical mode change.
