---
title: UCSI USB Operation Role command \Type-C MUTT\
Description: UCSI USB Operation Role command [Type-C MUTT]
ms.assetid: 
...
# UCSI USB Operation Role command \[Type-C MUTT\]

Verifies that the system supports the UCSI Set USB Operation Role command.
