---
title: Camera Driver Test - Preview (Sample Grabber), Capture JPEGXR image from each image Stream type
description: Camera Driver Test - Preview (Sample Grabber), Capture JPEGXR image from each image Stream type
MSHAttr:
