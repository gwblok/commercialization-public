---
title: UCSI USB Operation Mode command - UFP to DFP connection \Type-C MUTT\
Description: UCSI USB Operation Mode command - UFP to DFP connection [Type-C MUTT]
ms.assetid: 
...
# UCSI USB Operation Mode command - UFP to DFP connection \[Type-C MUTT\]

Sets the UCSI USB Operation Mode of the system to UFP and the partner to DFP and confirms that a connection is established.
