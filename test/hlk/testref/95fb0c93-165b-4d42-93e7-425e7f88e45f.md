---
title: UCSI commands - Unsupported command \Type-C MUTT\
Description: UCSI commands - Unsupported command [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Unsupported command \[Type-C MUTT\]

Verifies that the system fails a UCSI command that it does not recognize, and sets the 'Not Supported Indicator'.
