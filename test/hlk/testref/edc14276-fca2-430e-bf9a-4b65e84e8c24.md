---
title: Camera Driver Test - Photo Capture - Capture a GIF photo from the default format advertised on the camera's preferred stream for photo
description: Camera Driver Test - Photo Capture - Capture a GIF photo from the default format advertised on the camera's preferred stream for photo
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 9ee877e6-f077-44c5-8ef5-75530acf14bd
...
# <span id="p_hlk_test.edc14276-fca2-430e-bf9a-4b65e84e8c24"></span>Camera Driver Test - Photo Capture - Capture a GIF photo from the default format advertised on the camera's preferred stream for photo
