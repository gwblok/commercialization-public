---
title: UCSI Power Direction Role command - Reject swap \Type-C MUTT\
Description: UCSI Power Direction Role command - Reject swap [Type-C MUTT]
ms.assetid: 
...
# UCSI Power Direction Role command - Reject swap \[Type-C MUTT\]
