...
<td><ul>
<li><p>Check the thin provisioned LUN to make sure VPD B0h page&#39;s LBPU bit is set to one (or run <a href="b6ca1543-aee5-4390-8f16-f3a5dd5d35e7.md" data-raw-source="[Thin Provisioning SCSI Compliance Test (LOGO)](b6ca1543-aee5-4390-8f16-f3a5dd5d35e7.md)">Thin Provisioning SCSI Compliance Test (LOGO)</a> to verify the compliance of the LUN).</p></li>
