---
title: Camera Driver Test - Photo Capture - Capture a Bitmap photo from each type exposed by the photo pin
description: Camera Driver Test - Photo Capture - Capture a Bitmap photo from each type exposed by the photo pin
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 0229285a-172d-4249-92c5-6ac6c2472f33
...
# <span id="p_hlk_test.830ec3ab-2ba2-4ba4-b777-53048393a532"></span>Camera Driver Test - Photo Capture - Capture a Bitmap photo from each type exposed by the photo pin
