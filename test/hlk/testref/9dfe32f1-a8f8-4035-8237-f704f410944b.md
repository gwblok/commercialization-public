---
title: UCSI USB Operation Role command - Reject swap \Type-C MUTT\
Description: UCSI USB Operation Role command - Reject swap [Type-C MUTT]
ms.assetid: 
...
# UCSI USB Operation Role command - Reject swap \[Type-C MUTT\]

Verifies that the system rejects data role swaps from the partner when instructed to do so using the UCSI Set USB Operation Role command.
