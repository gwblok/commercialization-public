---
title: Camera Driver Profiles Interface APIs (Device Test)
description: Camera Driver Device Test - MediaCapture - TestVideoProfileSupportedFlags
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
Search.SourceType: Video
ms.assetid: c554ffb5-2685-4814-adf5-44f5da4c9be8
