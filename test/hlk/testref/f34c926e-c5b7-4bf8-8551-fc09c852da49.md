---
title: Camera Driver Test - Photo Capture - Capture a GIF photo from each type exposed by the photo pin
description: Camera Driver Test - Photo Capture - Capture a GIF photo from each type exposed by the photo pin
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 703a03e6-bae9-4d65-8d65-ebf75fc9bae3
...
# <span id="p_hlk_test.f34c926e-c5b7-4bf8-8551-fc09c852da49"></span>Camera Driver Test - Photo Capture - Capture a GIF photo from each type exposed by the photo pin
