---
title: WDDM2.2 Periodic frame notification - Cancel on mode change - GPU wait
Description: WDDM2.2 Periodic frame notification - Cancel on mode change - GPU wait
ms.assetid: 
