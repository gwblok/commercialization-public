---
title: D3D12 - Late Latch Atomic Copy UINT64
Description: D3D12 - Late Latch Atomic Copy UINT64
ms.assetid: 
...
Verifies 8 bytes can be atomically copied when naturally aligned.
