---
title: UCSI Get Connector Status - PD Reset Complete \Type-C MUTT\
Description: UCSI Get Connector Status - PD Reset Complete [Type-C MUTT]
ms.assetid: 
...
# UCSI Get Connector Status - PD Reset Complete \[Type-C MUTT\]

Verifies that the system reports a 'PD Reset Complete' notification in response to receiving a Power Delivery Hard Reset on a connector.
...
| **PDResetCompleteNotification** | Set to False if the SUT cannot trigger the PD Reset Complete notification. |
