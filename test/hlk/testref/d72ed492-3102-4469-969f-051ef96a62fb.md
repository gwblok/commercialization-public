---
title: UCSI USB Operation Mode command - DRP to DFP connection \Type-C MUTT\
Description: UCSI USB Operation Mode command - DRP to DFP connection [Type-C MUTT]
ms.assetid: 
...
# UCSI USB Operation Mode command - DRP to DFP connection \[Type-C MUTT\]
