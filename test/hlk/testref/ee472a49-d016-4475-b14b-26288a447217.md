---
title: Wireless Display Verify Session Connect Disconnect
description: Wireless Display Verify Session Connect Disconnect
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: d83cfd23-5207-48b5-ad60-888456ae29df
...
# <span id="p_hlk_test.ee472a49-d016-4475-b14b-26288a447217"></span>Wireless Display Verify Session Connect Disconnect
...
<tbody>
<tr class="odd">
<td><p>Start session failed with result …</p></td>
<td><p>Miracast session failed to start.</p></td>
</tr>
<tr class="even">
<td><p>Expected session started result of …</p></td>
<td><p>Miracast session started in unexpected state.</p></td>
</tr>
<tr class="odd">
<td><p>Device reported success but session failed to reach the stopped state.</p></td>
<td><p>Miracast session failed to stop.</p></td>
</tr>
</tbody>
</table>
