---
title: Gyrometer Dynamic Range Tests
Description: Gyrometer Dynamic Range Tests
ms.assetid: 
...
# Gyrometer Dynamic Range Tests

Verifies that the dynamic range for Gyrometer data fields are withing range

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>System.Client.Sensor.Gyrometer.DynamicRange</li></ul> |  
