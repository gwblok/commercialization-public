---
title: Camera Driver Test - Preview (Sample Grabber), Capture GIF image from each image Stream type
description: Camera Driver Test - Preview (Sample Grabber), Capture GIF image from each image Stream type
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: c86e1694-5c67-4341-a9ac-f01a65308a1e
...
# <span id="p_hlk_test.a9f352b5-f75e-490c-82df-34a6a397ada4"></span>Camera Driver Test - Preview (Sample Grabber), Capture GIF image from each image Stream type
