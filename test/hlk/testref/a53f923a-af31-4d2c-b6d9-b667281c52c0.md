---
title: D3D12 - DXIL Core Test - Basic shader model 6.1 test
Description: D3D12 - DXIL Core Test - Basic shader model 6.1 test
ms.assetid: 
...
Verifies shader model 6.1 support.

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Graphics.WDDM23.AdapterRender.D3D12.DXILCore.ShaderModel61.CoreRequirement</li></ul> |  
