---
title: Camera Driver Test - MultiCamera Preview (Sample Grabber), Capture JPEG image from each image Stream type
description: Camera Driver Test - MultiCamera Preview (Sample Grabber), Capture JPEG image from each image Stream type
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 5afb08b0-70aa-42b8-9751-2b903c5c7de2
...
# <span id="p_hlk_test.b2fa38fa-e7c1-4adf-b790-623247f50c5c"></span>Camera Driver Test - MultiCamera Preview (Sample Grabber), Capture JPEG image from each image Stream type
