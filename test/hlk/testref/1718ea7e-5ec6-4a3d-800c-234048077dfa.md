---
title: Gyrometer minimum report interval verification tests
Description: Gyrometer minimum report interval verification tests
ms.assetid: 
...
# Gyrometer minimum report interval verification tests
...
|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.Gyrometer.MinimumReportInterval</li></ul> |  
