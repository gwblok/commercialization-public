---
title: Camera Driver Test - Preview (Sample Grabber), Capture JPEG image from each image Stream type
description: Camera Driver Test - Preview (Sample Grabber), Capture JPEG image from each image Stream type
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 5dcb7728-f631-42ca-9e73-2a93311572ad
...
# <span id="p_hlk_test.36e00f8b-7946-4cbc-990c-58965a900e3e"></span>Camera Driver Test - Preview (Sample Grabber), Capture JPEG image from each image Stream type
