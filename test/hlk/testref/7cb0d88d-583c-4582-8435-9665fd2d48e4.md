---
title: \Dual-Role MUTT\ Bulk IO Tests (Long)
description: \ Dual-Role MUTT\ Bulk IO Tests (Long)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: ca0cf35a-36b3-4db2-9c19-d11dd2901b6a
...
# \[Dual-Role MUTT\] Bulk IO Tests (Long)
...
|-----------------------|---------------------------------------------------------------------------------------------------|
| **BulkIoTimeoutInMs** | Duration of time, specified in milliseconds, for which the Dual-Role MUTT should repeat the tests |
