---
title: Geomagnetic Orientation Sensor Thresholds Verification Test
Description: Geomagnetic Orientation Sensor Thresholds Verification Test
ms.assetid: 
...
# Geomagnetic Orientation Sensor Thresholds Verification Test

Verifies that the required thresholds fields are present in Geomagnetic Orientation Sensor

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.GeomagneticOrientationSensor.Thresholds</li></ul> |  
