---
title: UCSI commands - Get Current Connector Alternate Mode \Type-C MUTT\
Description: UCSI commands - Get Current Connector Alternate Mode [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Get Current Connector Alternate Mode \[Type-C MUTT\]

Verifies that the system supports the UCSI Get Current Connector Alternate Mode command.
