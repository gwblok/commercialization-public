---
title: UCSI commands - Get Alternate Modes, SOP \Type-C MUTT\
Description: UCSI commands - Get Alternate Modes, SOP [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Get Alternate Modes, SOP \[Type-C MUTT\]

Verifies that the system supports the UCSI Get Alternate Modes command, with 'Recipient' as 'SOP'.
