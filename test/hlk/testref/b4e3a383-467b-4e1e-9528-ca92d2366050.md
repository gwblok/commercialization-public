---
title: Camera Driver Test - Preview (Sample Grabber), Capture Bitmap image from each image Stream type
description: Camera Driver Test - Preview (Sample Grabber), Capture Bitmap image from each image Stream type
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 40d53dec-b921-4321-9a2c-ec30c5ce4899
...
# <span id="p_hlk_test.b4e3a383-467b-4e1e-9528-ca92d2366050"></span>Camera Driver Test - Preview (Sample Grabber), Capture Bitmap image from each image Stream type
