---
title: D3D12 - CPU MMU Isolation
Description: D3D12 - CPU MMU Isolation
ms.assetid: 
...
Verify either the GPU is isolated from CPU MMU features or the driver correctly advertises some functionality is honored by GPU.
