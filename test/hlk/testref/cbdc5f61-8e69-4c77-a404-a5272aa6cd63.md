---
title: Camera Driver Controls System Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_VideoRecording is supported, set first index
description: Camera Driver Controls System Test - CAMERA\_PROFILES - Verify KSCAMERAPROFILE\_VideoRecording is supported, set first index
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 6194c1ad-94b2-4e1a-8d1c-b8d22761962e
...
# Camera Driver Controls System Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_VideoRecording is supported, set first index
