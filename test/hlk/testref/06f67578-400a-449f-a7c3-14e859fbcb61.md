---
title: Wireless Display Verify PnpStop
description: Wireless Display Verify PnpStop
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: b6863c60-c29a-4960-8570-e8290de65866
...
# <span id="p_hlk_test.06f67578-400a-449f-a7c3-14e859fbcb61"></span>Wireless Display Verify PnpStop


This automated test verifies that the graphics driver provides stability and reliability when a PnP event occurs during different Miracast active session scenarios. The test installs a software device to emulate Miracast sink, starts a session, and then disables the graphics adapter, thereby forcing the operating system to unload the driver.
...
<tbody>
<tr class="odd">
<td><p>Failed: Miracast device should be stopped if an adapter had been disabled.</p></td>
<td><p>Driver failed to stop Miracast session.</p></td>
</tr>
<tr class="even">
<td><p>Virtual sink thread failed to exit.</p></td>
<td><p>Driver failed to inform a sink that the session had been stopped.</p></td>
</tr>
<tr class="odd">
<td><p>QueryMiracastDisplayDeviceStatus failed with status …</p></td>
<td><p>Driver placed Miracast device in an incorrect state.</p></td>
</tr>
</tbody>
</table>
