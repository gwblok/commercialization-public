...
# ActivitySensor DriverFramework Validation
...
|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.ActivitySensor.WinRT.Discretional</li><li>Device.Input.Sensor.General.DriverFramework</li></ul> |  
