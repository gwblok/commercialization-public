---
title: UCSI commands - Get PDOs, Current Supported Source Capabilities \Type-C MUTT\
Description: UCSI commands - Get PDOs, Current Supported Source Capabilities [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Get PDOs, Current Supported Source Capabilities \[Type-C MUTT\]

Verifies that the system supports the UCSI Get PDOs command, with 'Source Capabilities Type' as 'Current Supported Source Capabilities'.
