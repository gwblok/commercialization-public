---
title: D3D12 - DXIL Core Test - Basic shader model 6.3 test
Description: D3D12 - DXIL Core Test - Basic shader model 6.3 test
ms.assetid: 
...
Verifies shader model 6.3 support.

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Graphics.WDDM25.AdapterRender.D3D12.DXILCore.ShaderModel63.CoreRequirement</li></ul> |  
