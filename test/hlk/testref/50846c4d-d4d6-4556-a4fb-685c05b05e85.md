---
title: Common data field verification tests
Description: Common data field verification tests
ms.assetid: 
...
# Common data field verification tests

Verifies that the sensor exposes all required common data fields
