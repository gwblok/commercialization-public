---
title: Camera Driver Controls Device Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_VideoRecording is supported, set first index
description: Camera Driver Controls Device Test - CAMERA\_PROFILES - Verify KSCAMERAPROFILE\_VideoRecording is supported, set first index
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
Search.SourceType: Video
ms.assetid: 31dd7815-6a66-4519-a575-b5d25f18f103
...
# Camera Driver Controls Device Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_VideoRecording is supported, set first index
