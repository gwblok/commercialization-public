---
title: Relative Orientation Sensor Data Fields Verification Test
Description: Relative Orientation Sensor Data Fields Verification Test
ms.assetid: 
...
# Relative Orientation Sensor Data Fields Verification Test

Verifies that the required data fields are present for the Relative orientation sensor

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.RelativeOrientation.DataTypes</li></ul> |  
