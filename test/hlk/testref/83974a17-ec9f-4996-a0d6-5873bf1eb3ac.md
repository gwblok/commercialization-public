...
<div class="alert">
<strong>Important</strong><br/><p>If you are using an EHCI host controller on the SUT computer, the cable must be connected to Port 1 of the controller. You can use the UsbView tool to identify Port 1. USBView is included in the WDK.</p>
</div>
<div>
