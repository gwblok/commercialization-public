---
title: System Audio - MediaCapture API Test - Test Audio Capture
description: System Audio - MediaCapture API Test - Test Audio Capture
MSHAttr:
...
|**Expected run time (in minutes)**| 100 |
