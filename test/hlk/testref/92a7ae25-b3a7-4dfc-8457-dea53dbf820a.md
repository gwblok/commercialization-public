---
title: Linear Accelerometer Sensor Data Fields Verification Test
Description: Linear Accelerometer Sensor Data Fields Verification Test
ms.assetid: 
...
Verifies that the required data fields are present for the Linear Accelerometer sensor

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.LinearAccelerometer.DataTypes</li></ul> |  
