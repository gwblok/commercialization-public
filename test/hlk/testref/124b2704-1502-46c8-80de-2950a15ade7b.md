---
title: UCSI commands - Set Notification Enable \Type-C MUTT\
Description: UCSI commands - Set Notification Enable [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Set Notification Enable \[Type-C MUTT\]

Verifies that the system supports the UCSI Set Notification Enable command.
