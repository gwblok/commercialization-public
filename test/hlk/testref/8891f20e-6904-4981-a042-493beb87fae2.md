---
title: UCSI Power Direction Role command - Accept swap \Type-C MUTT\
Description: UCSI Power Direction Role command - Accept swap [Type-C MUTT]
ms.assetid: 
...
# UCSI Power Direction Role command - Accept swap \[Type-C MUTT\]

Verifies that the system accepts power role swaps from the partner when instructed to do so using the UCSI Set Power Direction Role command.
