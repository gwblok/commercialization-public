---
title: Camera Driver Controls Device Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_HighQualityPhoto is supported, set first index
description: Camera Driver Controls Device Test - CAMERA\_PROFILES - Verify KSCAMERAPROFILE\_HighQualityPhoto is supported, set first index
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
Search.SourceType: Video
ms.assetid: 06153407-8c41-4c14-b553-90ef9295ae7c
...
# Camera Driver Controls Device Test - CAMERA_PROFILES - Verify KSCAMERAPROFILE_HighQualityPhoto is supported, set first index
