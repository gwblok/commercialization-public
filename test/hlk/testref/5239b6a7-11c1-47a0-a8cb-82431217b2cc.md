---
title: UCSI commands - Get PDOs, Sink Capabilities \Type-C MUTT\
Description: UCSI commands - Get PDOs, Sink Capabilities [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Get PDOs, Sink Capabilities \[Type-C MUTT\]

Verifies that the system supports the UCSI Get PDOs command, for retrieving the system's Sink Capabilities.
