---
title: UCSI commands - Get Connector Capability \Type-C MUTT\
Description: UCSI commands - Get Connector Capability [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Get Connector Capability \[Type-C MUTT\]

Verifies that the system supports the UCSI Get Connector Capability command.
