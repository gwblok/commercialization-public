---
title: UCSI Power Direction Role command - Reset on disconnect \Type-C MUTT\
Description: UCSI Power Direction Role command - Reset on disconnect [Type-C MUTT]
ms.assetid: 
...
# UCSI Power Direction Role command - Reset on disconnect \[Type-C MUTT\]

Verifies that the power role requested using the UCSI Set Power Direction Role command persists only for the duration of the current connection.
