---
title: Wireless Display Verify Hibernate
description: Wireless Display Verify Hibernate
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: b3fda01f-574b-4854-b620-b64511e162e6
...
# <span id="p_hlk_test.fe9899b4-ba54-407c-bc2f-b42de497874b"></span>Wireless Display Verify Hibernate


This automated test verifies that the graphics driver provides stability and reliability when an active Miracast session is stopped by hibernation and then started again after system resume. The test installs a software device to emulate Miracast sink, starts a session, and then forces transition into a hibernate state if the system supports it.
...
<tr class="even">
<td><p>Failed to connect a Miracast monitor after power transition.</p></td>
