---
title: UCSI commands - Get Alternate Modes, SOP-Prime \Type-C MUTT\
Description: UCSI commands - Get Alternate Modes, SOP-Prime [Type-C MUTT]
ms.assetid: 
...
Verifies that the system supports the UCSI Get Alternate Modes command, with 'Recipient' as 'SOP-Prime'.
