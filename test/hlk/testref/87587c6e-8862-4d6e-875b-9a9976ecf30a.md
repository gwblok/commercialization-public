---
title: DF - PNP Remove Device Test (Development and Integration)
description: DF - PNP Remove Device Test (Development and Integration)
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: a7062e21-5c07-45ca-9b96-12be3ab8f8d4
...
# <span id="p_hlk_test.87587c6e-8862-4d6e-875b-9a9976ecf30a"></span>DF - PNP Remove Device Test (Development and Integration)


This test uses the EDT filter driver to send causes IRP\_MN\_QUERY\_REMOVE\_DEVICE and IRP\_MN\_REMOVE\_DEVICE to be sent to target device stacks.
