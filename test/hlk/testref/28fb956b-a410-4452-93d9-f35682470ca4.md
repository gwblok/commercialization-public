---
title: UCSI USB Operation Role command - No connection \Type-C MUTT\
Description: UCSI USB Operation Role command - No connection [Type-C MUTT]
ms.assetid: 
...
# UCSI USB Operation Role command - No connection \[Type-C MUTT\]

Verifies that the UCSI Set USB Operation Role command fails if a partner is not currently attached.
