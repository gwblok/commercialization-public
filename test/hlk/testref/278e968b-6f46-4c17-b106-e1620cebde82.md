---
title: Pedometer minimum report interval verification tests
Description: Pedometer minimum report interval verification tests
ms.assetid: 
...
# Pedometer minimum report interval verification tests
...
|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.Pedometer.MinimumReportInterval</li></ul> |  
