---
title: Glitchfree Low-period Full-duplex Audio Playback & Capture test under stress
description: Glitchfree Low-period Full-duplex Audio Playback Capture test under stress
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 1bab33d7-2d41-4573-b0c2-fd02a74b04ee
...
# Glitchfree Low-period Full-duplex Audio Playback & Capture test under stress
...
The test verifies that a system is capable of playing Low-Period Audio and capturing it with no glitches during playback & recording under stress.
