---
title: D3D12 - Depth Bounds Test - Verify Depth Bounds Test correctly limits writes to the Render Target when no depth buffer is bound 
Description: D3D12 - Depth Bounds Test - Verify Depth Bounds Test correctly limits writes to the Render Target when no depth buffer is bound 
ms.assetid: 
