---
title: Magnetometer minimum report interval verification tests
Description: Magnetometer minimum report interval verification tests
ms.assetid: 
...
# Magnetometer minimum report interval verification tests
...
|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.Magnetometer.MinimumReportInterval</li></ul> |  
