---
title: GravityVector Orientation Sensor Data Fields Verification Test
Description: GravityVector Orientation Sensor Data Fields Verification Test
ms.assetid: 
...
# GravityVector Orientation Sensor Data Fields Verification Test

Verifies that the required data fields are present for the Gravity vector sensor

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>Device.Input.Sensor.GravityVectorSensor.DataTypes</li></ul> |  
