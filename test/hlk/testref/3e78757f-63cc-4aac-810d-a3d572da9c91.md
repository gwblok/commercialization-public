---
title: Light Sensor Dynamic Range Tests
Description: Light Sensor Dynamic Range Tests
ms.assetid: 
...
Verifies that the dynamic range for Light Sensor data fields are withing range

## Test details

|||
|---|---|
| **Specifications**  | <ul><li>System.Client.Sensor.AmbientLightSensor.DynamicRange</li></ul> |  
