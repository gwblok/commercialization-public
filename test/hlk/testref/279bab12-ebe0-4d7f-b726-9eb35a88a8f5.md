---
title: Camera Driver Test - Photo Capture - Capture a BGRA8 image from the default type exposed by the photo pin
description: Camera Driver Test - Photo Capture - Capture a BGRA8 image from the default type exposed by the photo pin
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: f2e081e9-8168-41b4-8f14-6e44ff232384
...
# <span id="p_hlk_test.279bab12-ebe0-4d7f-b726-9eb35a88a8f5"></span>Camera Driver Test - Photo Capture - Capture a BGRA8 image from the default type exposed by the photo pin
