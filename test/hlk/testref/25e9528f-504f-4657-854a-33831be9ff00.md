---
title: UCSI commands - Get Connector Status \Type-C MUTT\
Description: UCSI commands - Get Connector Status [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Get Connector Status \[Type-C MUTT\]

Verifies that the system supports the UCSI Get Connector Status command.
