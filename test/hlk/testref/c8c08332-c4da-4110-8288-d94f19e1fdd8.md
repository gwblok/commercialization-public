---
title: UCSI commands - Get Alternate Modes, connector \Type-C MUTT\
Description: UCSI commands - Get Alternate Modes, connector [Type-C MUTT]
ms.assetid: 
...
# UCSI commands - Get Alternate Modes, connector \[Type-C MUTT\]

Verifies that the system supports the UCSI Get Alternate Modes command, with 'Recipient' as 'Connector'.
