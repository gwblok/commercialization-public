---
title: UCSI USB Operation Mode command - PPM-Reset clears UFP Operation Mode \Type-C MUTT\
Description: UCSI USB Operation Mode command - PPM-Reset clears UFP Operation Mode [Type-C MUTT]
ms.assetid: 
...
# UCSI USB Operation Mode command - PPM-Reset clears UFP Operation Mode \[Type-C MUTT\]
